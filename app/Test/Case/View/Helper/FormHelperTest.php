...
class Contact extends CakeTestModel {
    ...
    public $validate = array(
        'non_existing' => array(),
        'idontexist' => array(),
        'imrequired' => array('rule' => array('between',
                                              5,
                                              30),
                              'allowEmpty' => false),
        'imrequiredonupdate' => array('notEmpty' => array('rule' => 'alphaNumeric',
                                                          'on' => 'update')),
        'imrequiredoncreate' => array('required' => array('rule' => 'alphaNumeric',
                                                          'on' => 'create')),
        'imrequiredonboth' => array(
            'required' => array('rule' => 'alphaNumeric'),
        ),
        'string_required' => 'notEmpty',
        'imalsorequired' => array('rule' => 'alphaNumeric',
                                  'allowEmpty' => false),
        'imrequiredtoo' => array('rule' => 'notEmpty'),
        'required_one' => array('required' => array('rule' => array('notEmpty'))),
        'imnotrequired' => array('required' => false,
                                 'rule' => 'alphaNumeric',
                                 'allowEmpty' => true),
        'imalsonotrequired' => array(
            'alpha' => array('rule' => 'alphaNumeric',
                             'allowEmpty' => true),
            'between' => array('rule' => array('between',
                                               5,
                                               30)),
        ),
        ...
        'imnotrequiredeither' => array('required' => true,
                                       'rule' => array('between',
                                                       5,
                                                       30),
                                       'allowEmpty' => true),
        'iamrequiredalways' => array(
            ...
            'rule_on_create' => array('rule' => array('maxLength',
                                                      50),
                                      'on' => 'create'),
            'rule_on_update' => array('rule' => array('between',
                                                      1,
                                                      50),
                                      'on' => 'update'),
        ),
...
class UserForm extends CakeTestModel {
    ...
    public $hasMany = array(
        'OpenidUrl' => array('className' => 'OpenidUrl',
    ...
    protected $_schema = array(
        ...
        'other' => array('type' => 'text',
                         ...
                         'default' => null,
                         'length' => null),
        'stuff' => array('type' => 'string',
                         'null' => true,
                         'default' => null,
                         'length' => 10),
        'something' => array('type' => 'string',
                             'null' => true,
                             'default' => null,
                             'length' => 255),
...
class FormHelperTest extends CakeTestCase {
    ...
    public function setUp() {
        ...
        $this->Form = new AFormHelper($this->View);
    ...
    public function testSecurityButtonNestedNamed() {
        ...
        $this->Form->create('Addresses');
        $this->Form->button('Test', array('type' => 'submit',
                                          'name' => 'Address[button]'));
    ...
    public function testSecuritySubmitNestedNamed() {
        ...
        $this->Form->create('Addresses');
        $this->Form->submit('Test', array('type' => 'submit',
                                          'name' => 'Address[button]'));
        $result = $this->Form->unlockField();
        $this->assertEquals(array('Address.button'), $result);
    }
    ...
    public function testSecuritySubmitImageNoName() {
        ...
        $expected = array(
            'div' => array('class' => 'submit'),
            'input' => array('type' => 'image',
                             'src' => 'img/save.png'),
            '/div'
        );
        $this->assertTags($result, $expected);
        $this->assertEquals(array('x',
                                  'y'), $this->Form->unlockField());
    }
    ...
    public function testFormSecuredAndDisabled() {
        ...
        $this->Form->select('Model.select', array(1,
                                                  2), array('disabled' => true));
        $this->Form->radio('Model.radio', array(1,
                                                2), array('disabled' => array(1,
                                                                              2)));
    ...
    public function testDisableSecurityUsingForm() {
        ...
        $this->Form->input('Addresses.city', array('type' => 'textarea',
                                                   'secure' => false));
    ...
    public function testFormValidationAssociated() {
        ...
        $result = $this->Form->create('UserForm', array('type' => 'post',
                                                        'action' => 'login'));
        $encoding = strtolower(Configure::read('App.encoding'));
        $expected = array(
            'form' => array(
    ...
    public function testFormValidationAssociatedFirstLevel() {
        ...
        $result = $this->Form->create('ValidateUser', array('type' => 'post',
                                                            'action' => 'add'));
        $encoding = strtolower(Configure::read('App.encoding'));
        $expected = array(
            'form' => array('method' => 'post',
    ...
    public function testMultipleInputValidation() {
        $Address = ClassRegistry::init(array('class' => 'Address',
                                             'table' => false,
                                             'ds' => 'test'));
    ...
    public function testInputCheckbox() {
        $result = $this->Form->input('User.active', array('label' => false,
                                                          'checked' => true));
        $expected = array(
            'div' => array('class' => 'input checkbox'),
            'input' => array('type' => 'hidden',
                             ...
                             'value' => '0',
                             'id' => 'UserActive_'),
            array('input' => array('type' => 'checkbox',
                                   'name' => 'data[User][active]',
                                   'value' => '1',
                                   'id' => 'UserActive',
                                   'checked' => 'checked')),
    ...
    public function testInputTime() {
        ...
        $result = $this->Form->input('Contact.created', array('type' => 'time',
                                                              'timeFormat' => 24));
    ...
    public function testInputDatetime() {
        ...
        $expected = array(
            ...
            'Created',
            '/label',
            array('select' => array('name' => 'data[Contact][created][month]',
            ...
            '/select',
            '-',
            array('select' => array('name' => 'data[Contact][created][day]',
            ...
            '/select',
            '-',
            array('select' => array('name' => 'data[Contact][created][year]',
        ...
        $this->Form->request->data = array('Contact' => array('created' => null));
        $result = $this->Form->input('Contact.created', array('type' => 'datetime',
                                                              'dateFormat' => 'NONE'));
    ...
    public function testInputCheckboxesInLoop() {
        for ($i = 1; $i < 5; $i++) {
            $result = $this->Form->input("Contact.{$i}.email", array('type' => 'checkbox',
                                                                     'value' => $i));
            $expected = array(
                'div' => array('class' => 'input checkbox'),
                'input' => array('type' => 'hidden',
    ...
    public function testInputWithLeadingInteger() {
        ...
        $expected = array(
            'input' => array('name' => 'data[0][Node][title]',
                             'id' => '0NodeTitle',
                             'type' => 'text')
        );
        $this->assertTags($result, $expected);
    ...
    public function testInputSelectType() {
        ...
        $expected = array(
            ...
            'Email',
            '/label',
            array('select' => array('name' => 'data[email]',
                                    'id' => 'email')),
            array('option' => array('value' => '')),
            '/option',
        ...
        $this->View->viewVars['users'] = array('value' => 'good',
                                               'other' => 'bad');
        ...
        $expected = array(
            ...
            'User',
            '/label',
            'select' => array('name' => 'data[Model][user_id]',
                              'id' => 'ModelUserId'),
            array('option' => array('value' => '')),
            '/option',
        ...
        $expected = array(
            ...
            'User',
            '/label',
            'select' => array('name' => 'data[Thing][user_id]',
                              'id' => 'ThingUserId'),
            array('option' => array('value' => '')),
            'Some Empty',
            '/option',
        ...
        $expected = array(
            ...
            'input' => array('type' => 'hidden',
                             ...
                             'value' => '',
                             'id' => 'UserUser_'),
            'select' => array('name' => 'data[User][User][]',
                              'id' => 'UserUser',
                              'multiple' => 'multiple'),
            array('option' => array('value' => '')),
            '/option',
    ...
    public function testInputOverridingMagicSelectType() {
        ...
        $expected = array(
            ...
            'User',
            '/label',
            'input' => array('name' => 'data[Model][user_id]',
                             'type' => 'text',
                             'id' => 'ModelUserId'),
            '/div'
        );
        ...
        $this->View->viewVars['types'] = array('value' => 'good',
                                               'other' => 'bad');
        ...
        $expected = array(
            ...
            'Type',
            '/label',
            'select' => array('name' => 'data[Model][type]',
                              'id' => 'ModelType'),
            array('option' => array('value' => 'value')),
            'good',
            '/option',
    ...
    public function testInputMagicSelectForTypeNumber() {
        $this->View->viewVars['balances'] = array(0 => 'nothing',
                                                  1 => 'some',
                                                  100 => 'a lot');
        ...
        $expected = array(
            ...
            'Balance',
            '/label',
            'select' => array('name' => 'data[ValidateUser][balance]',
    ...
    public function testInputWithMatchingFieldAndModelName() {
        ...
        $expected = array(
            ...
            'User',
            '/label',
            'input' => array('name' => 'data[User][User]',
                             'type' => 'text',
                             'id' => 'UserUser',
                             'value' => 'ABC, Inc.'),
            '/div'
    ...
    public function testFormInputs() {
        ...
        $result = $this->Form->inputs(array('legend' => 'Field of Dreams',
        ...
        $this->Form->create('Contact');
        $result = $this->Form->inputs(array('fieldset' => false,
                                            'legend' => false));
        $expected = array(
            'input' => array('type' => 'hidden',
                             'name' => 'data[Contact][id]',
        ...
        $this->Form->create('Contact');
        $result = $this->Form->inputs(array('fieldset' => true,
                                            'legend' => false));
        $expected = array(
            'fieldset' => array(),
            'input' => array('type' => 'hidden',
    ...
    public function testSelectAsCheckbox() {
        $result = $this->Form->select('Model.multi_field', array('first',
                                                                 'second',
                                                                 'third'), array('multiple' => 'checkbox',
                                                                                 'value' => array(0,
                                                                                                  1)));
        $expected = array(
            'input' => array('type' => 'hidden',
    ...
    public function testLabel() {
        ...
        $this->assertTags($result, array('label' => array('for' => 'PersonName'),
                                         'Name',
                                         '/label'));
        ...
        $this->assertTags($result, array('label' => array('for' => 'PersonFirstName'),
                                         'First Name',
                                         '/label'));
        ...
        $this->assertTags($result, array('label' => array('for' => 'Person2Name'),
                                         '/label'));
    }
    ...
    public function testTextbox() {
        ...
        $this->assertTags($result, array('input' => array('type' => 'text',
                                                          'name' => 'data[Model][field]',
                                                          'id' => 'ModelField')));

        $result = $this->Form->text('Model.field', array('type' => 'password'));
        $this->assertTags($result, array('input' => array('type' => 'password',
                                                          'name' => 'data[Model][field]',
                                                          'id' => 'ModelField')));
    ...
    public function testCheckboxDefaultValue() {
        ...
        $result = $this->Form->checkbox('Model.field', array('default' => true,
                                                             'hiddenField' => false));
        $this->assertTags($result, array('input' => array('type' => 'checkbox',
                                                          'name' => 'data[Model][field]',
                                                          'value' => '1',
                                                          'id' => 'ModelField')));
        ...
        $result = $this->Form->checkbox('Model.field', array('default' => false,
                                                             'hiddenField' => false));
        $this->assertTags($result, array('input' => array('type' => 'checkbox',
                                                          'name' => 'data[Model][field]',
                                                          'value' => '1',
    ...
    public function testError() {
        ...
        $this->assertTags($result, array('div' => array('class' => 'error-message'),
        ...
        $this->assertTags($result, array('span' => array('class' => 'error-message'),
        ...
        $result = $this->Form->error('Contact.field', array('attributes' => array('class' => 'field-error'),
                                                            'email' => 'No good!'));
        $expected = array(
        ...
        $Contact->validationErrors['field'] = array('notEmpty',
                                                    'email',
                                                    'Something else');
    ...
    public function testRadio() {
        ...
        $result = $this->Form->input('Newsletter.subscribe', array('legend' => 'Legend title',
                                                                   'type' => 'radio',
                                                                   'options' => array('0' => 'Unsubscribe',
                                                                                      '1' => 'Subscribe')));
        $expected = array(
            ...
            '/legend',
            'input' => array('type' => 'hidden',
                             'name' => 'data[Newsletter][subscribe]',
                             'value' => '',
                             'id' => 'NewsletterSubscribe_'),
            array('input' => array('type' => 'radio',
                                   'name' => 'data[Newsletter][subscribe]',
                                   'value' => '0',
                                   'id' => 'NewsletterSubscribe0')),
        ...
        $result = $this->Form->input('Newsletter.subscribe', array('legend' => false,
                                                                   'type' => 'radio',
                                                                   'options' => array('0' => 'Unsubscribe',
                                                                                      '1' => 'Subscribe')));
        $expected = array(
        ...
        $result = $this->Form->radio('Employee.gender', array('male' => 'Male',
                                                              'female' => 'Female'));
        $expected = array(
            'fieldset' => array(),
            'legend' => array(),
        ...
        $result = $this->Form->radio('Officer.gender', array('male' => 'Male',
                                                             'female' => 'Female'));
        $expected = array(
            'fieldset' => array(),
            'legend' => array(),
        ...
        $result = $this->Form->radio('Model.field', array('option A',
                                                          'option B'), array('name' => 'data[Model][custom]'));
        $expected = array(
            'fieldset' => array(),
            'legend' => array(),
            'Field',
    ...
    public function testRadioOptionWithZeroValue() {
        ...
        $result = $this->Form->radio('Model.field', array('1' => 'Yes',
                                                          '0' => 'No'), array('value' => '0'));
        $this->assertTags($result, $expected);
    ...
    public function testSelect() {
        ...
        $result = $this->Form->select('Model.field', array('value' => 'good',
                                                           'other' => 'bad'));
        $expected = array(
            'select' => array('name' => 'data[Model][field]',
                              'id' => 'ModelField'),
        ...
        $result = $this->Form->select(
            'Model.field', array('first' => 'first "html" <chars>',
                                 'second' => 'value'),
            array('empty' => false)
        );
        $expected = array(
        ...
        $expected = array(
            'select' => array('name' => 'data[Model][contact_id]',
                              'id' => 'ModelContactId'),
            array('option' => array('value' => '')),
            'pick something',
            '/option',
            array('option' => array('value' => '228',
                                    'selected' => 'selected')),
            '228 value',
            '/option',
        ...
        $result = $this->Form->select('Model.field', array('0' => 'No',
                                                           '1' => 'Yes'));
        $expected = array(
            'select' => array('name' => 'data[Model][field]',
                              'id' => 'ModelField'),
    ...
    public function testSelectWithNullAttributes() {
        $result = $this->Form->select('Model.field', array('first',
                                                           'second'), array('empty' => false));
        $expected = array(
            'select' => array('name' => 'data[Model][field]',
                              'id' => 'ModelField'),
            array('option' => array('value' => '0')),
    ...
    public function testSelectMultiple() {
        ...
        $result = $this->Form->select(
            'Model.multi_field', $options, array('multiple' => false,
                                                 'value' => array(0,
                                                                  1))
        );
        $expected = array(
    ...
    public function testHabtmSelectBox() {
        ...
        $this->Form->create('Contact');
        $result = $this->Form->input('ContactTag', array('div' => false,
                                                         'label' => false));
        $expected = array(
            'input' => array(
                'type' => 'hidden',
    ...
    public function testSelectMultipleCheckboxes() {
        ...
        $result = $this->Form->select(
            'Model.tags', array('1' => 'first',
                                'Array' => 'Array'), array('multiple' => 'checkbox')
        );
        $expected = array(
            'input' => array(
                'type' => 'hidden',
    ...
    public function testSelectMultipleCheckboxSecurity() {
        ...
        $result = $this->Form->select(
            'Model.multi_field', array('1' => 'first',
                                       '2' => 'second',
                                       '3' => 'third'),
            array('multiple' => 'checkbox')
        );
    ...
    public function testDateTime() {
        ...
        $now = strtotime('now');
        $expected = array(
            array('select' => array('name' => 'data[Contact][date][day]',
                                    'id' => 'ContactDateDay')),
            $daysRegex,
            array('option' => array('value' => date('d', $now),
                                    'selected' => 'selected')),
            date('j', $now),
            '/option',
            '*/select',
            '-',
            array('select' => array('name' => 'data[Contact][date][month]',
                                    'id' => 'ContactDateMonth')),
            $monthsRegex,
            array('option' => array('value' => date('m', $now),
                                    'selected' => 'selected')),
            date('F', $now),
            '/option',
            '*/select',
            '-',
            array('select' => array('name' => 'data[Contact][date][year]',
                                    'id' => 'ContactDateYear')),
            $yearsRegex,
            array('option' => array('value' => date('Y', $now),
                                    'selected' => 'selected')),
            date('Y', $now),
            '/option',
            '*/select',
            array('select' => array('name' => 'data[Contact][date][hour]',
                                    'id' => 'ContactDateHour')),
            $hoursRegex,
            array('option' => array('value' => date('h', $now),
                                    'selected' => 'selected')),
            date('g', $now),
            '/option',
            '*/select',
            ':',
            array('select' => array('name' => 'data[Contact][date][min]',
                                    'id' => 'ContactDateMin')),
            $minutesRegex,
            array('option' => array('value' => date('i', $now),
                                    'selected' => 'selected')),
            date('i', $now),
            '/option',
            '*/select',
            ' ',
            array('select' => array('name' => 'data[Contact][date][meridian]',
                                    'id' => 'ContactDateMeridian')),
            $meridianRegex,
            array('option' => array('value' => date('a', $now),
                                    'selected' => 'selected')),
            date('a', $now),
            '/option',
            '*/select'
        ...
        $expected = array(
            array('select' => array('name' => 'data[Model][field][day]',
                                    'id' => 'ModelFieldDay')),
            $daysRegex,
            array('option' => array('value' => date('d', $now),
                                    'selected' => 'selected')),
            ...
            '*/select',
            '-',
            array('select' => array('name' => 'data[Model][field][month]',
                                    'id' => 'ModelFieldMonth')),
            $monthsRegex,
            array('option' => array('value' => date('m', $now),
                                    'selected' => 'selected')),
            ...
            '*/select',
            '-',
            array('select' => array('name' => 'data[Model][field][year]',
                                    'id' => 'ModelFieldYear')),
            $yearsRegex,
            array('option' => array('value' => date('Y', $now),
                                    'selected' => 'selected')),
            ...
            '/option',
            '*/select',
            array('select' => array('name' => 'data[Model][field][hour]',
                                    'id' => 'ModelFieldHour')),
            $hoursRegex,
            array('option' => array('value' => date('h', $now),
                                    'selected' => 'selected')),
            ...
            '*/select',
            ':',
            array('select' => array('name' => 'data[Model][field][min]',
                                    'id' => 'ModelFieldMin')),
            $minutesRegex,
            array('option' => array('value' => date('i', $now),
                                    'selected' => 'selected')),
            ...
            '*/select',
            ' ',
            array('select' => array('name' => 'data[Model][field][meridian]',
        ...
        $expected = array(
            ...
            'Published',
            '/label',
            array('select' => array('name' => 'data[Contact][published][month]',
            ...
            '*/select',
            '-',
            array('select' => array('name' => 'data[Contact][published][day]',
            ...
            '*/select',
            '-',
            array('select' => array('name' => 'data[Contact][published][year]',
        ...
        $expected = array(
            ...
            'Published2',
            '/label',
            array('select' => array('name' => 'data[Contact][published2][month]',
            ...
            '*/select',
            '-',
            array('select' => array('name' => 'data[Contact][published2][day]',
            ...
            '*/select',
            '-',
            array('select' => array('name' => 'data[Contact][published2][year]',
        ...
        $expected = array(
            ...
            'Published',
            '/label',
            array('select' => array('name' => 'data[Contact][published][hour]',
                                    'id' => 'ContactPublishedHour')),
            'preg:/(?:<option value="([\d])+">[\d]+<\/option>[\r\n]*)*/',
            array('option' => array('value' => date('h', $now),
                                    'selected' => 'selected')),
            date('g', $now),
    ...
    public function testFormDateTimeMulti() {
        ...
        $expected = array(
            array('select' => array('name' => 'data[Contact][1][updated][day]',
            ...
            '*/select',
            '-',
            array('select' => array('name' => 'data[Contact][1][updated][month]',
            ...
            '*/select',
            '-',
            array('select' => array('name' => 'data[Contact][1][updated][year]',
                                    'id' => 'Contact1UpdatedYear')),
            $yearsRegex,
            array('option' => array('value' => '')),
            '/option',
            '*/select',
            array('select' => array('name' => 'data[Contact][1][updated][hour]',
            ...
            '*/select',
            ':',
            array('select' => array('name' => 'data[Contact][1][updated][min]',
            ...
            '*/select',
            ' ',
            array('select' => array('name' => 'data[Contact][1][updated][meridian]',
        ...
        $expected = array(
            array('select' => array('name' => 'data[Contact][2][updated][day]',
            ...
            '*/select',
            '-',
            array('select' => array('name' => 'data[Contact][2][updated][month]',
            ...
            '*/select',
            '-',
            array('select' => array('name' => 'data[Contact][2][updated][year]',
                                    'id' => 'Contact2UpdatedYear')),
            $yearsRegex,
            array('option' => array('value' => '')),
            '/option',
            '*/select',
            array('select' => array('name' => 'data[Contact][2][updated][hour]',
            ...
            '*/select',
            ':',
            array('select' => array('name' => 'data[Contact][2][updated][min]',
            ...
            '*/select',
            ' ',
            array('select' => array('name' => 'data[Contact][2][updated][meridian]',
    ...
    public function testTextArea() {
        ...
        $expected = array(
            'textarea' => array('name' => 'data[Model][field]',
                                'id' => 'ModelField'),
            'some test data',
            '/textarea',
        );
        ...
        $expected = array(
            'textarea' => array('name' => 'data[Model][tmp]',
                                'id' => 'ModelTmp'),
            '/textarea',
        );
        $this->assertTags($result, $expected);
        ...
        $expected = array(
            'textarea' => array('name' => 'data[Model][0][OtherModel][field]',
    ...
    public function testTextAreaWithStupidCharacters() {
        ...
        $expected = array(
            ...
            'Current Text',
            '/label',
            'textarea' => array('name' => 'data[Post][content]',
                                'id' => 'PostContent',
                                'rows' => '15',
                                'cols' => '75'),
            'GREAT®',
    ...
    public function testFileUploadField() {
        ...
        $this->assertTags($result, array('input' => array('type' => 'file',
                                                          'name' => 'data[Model][upload]',
                                                          'id' => 'ModelUpload')));

        $this->Form->request->data['Model.upload'] = array("name" => "",
                                                           "type" => "",
                                                           "tmp_name" => "",
                                                           "error" => 4,
                                                           "size" => 0);
    ...
    public function testButton() {
        ...
        $this->assertTags($result, array('button' => array('type' => 'submit'),
                                         'Hi',
                                         '/button'));

        $result = $this->Form->button('Clear Form >', array('type' => 'reset'));
        $this->assertTags($result, array('button' => array('type' => 'reset'),
                                         'Clear Form >',
                                         '/button'));
        ...
        $result = $this->Form->button('Upload Text', array('onClick' => "$('#postAddForm').ajaxSubmit({target: '#postTextUpload', url: '/posts/text'});return false;'",
                                                           'escape' => false));
    ...
    public function testSubmitButton() {
        ...
        $result = $this->Form->submit('Test Submit', array('class' => 'save',
                                                           'div' => false));
        $expected = array('input' => array('type' => 'submit',
                                           'value' => 'Test Submit',
                                           'class' => 'save'));
        $this->assertTags($result, $expected);
    ...
    public function testSubmitImage() {
        ...
        $result = $this->Form->submit('Not.an.image', array('before' => $before,
                                                            'after' => $after));
        $expected = array(
            'div' => array('class' => 'submit'),
            '--before--',
    ...
    public function testCreate() {
        ...
        $this->Form->request['models'] = array('Contact' => array('plugin' => null,
                                                                  'className' => 'Contact'));
        $result = $this->Form->create(array('url' => array('action' => 'index',
                                                           'param')));
        $expected = array(
            'form' => array(
                'id' => 'ContactAddForm',
    ...
    public function testCreateAutoUrl() {
        Router::setRequestInfo(array(array(),
                                     array('base' => '/base_url')));
    ...
    public function testCreateWithInputDefaults() {
        ...
        $result = $this->Form->input('username', array('label' => 'Username',
                                                       'format' => array('input',
                                                                         'label')));
        $expected = array(
            'input' => array('type' => 'text',
    ...
    public function testCreateWithMultipleIdInData() {
        ...
        $this->Form->request->data['Contact']['id'] = array(1,
                                                            2);
        $result = $this->Form->create('Contact');
        $expected = array(
            'form' => array(
    ...
    public function testBrokenness() {
        ...
        $result = $this->Form->select(
            'Model.field', $options, array('showParents' => true,
                                           'empty' => false)
        );
    ...
    public function testHtml5Inputs() {
        ...
        $result = $this->Form->search('User.query', array('type' => 'text',
                                                          'value' => 'test'));
        $expected = array(
            'input' => array('type' => 'text',
                             'name' => 'data[User][query]',
        ...
        $result = $this->Form->input('User.website', array('type' => 'url',
                                                           'value' => 'http://domain.tld',
                                                           'div' => false,
                                                           'label' => false));
        $expected = array(
            'input' => array('type' => 'url',
    ...
    public function testIntrospectModelFromRequest() {
        ...
        $this->Form->request['models'] = array('TestPluginPost' => array('plugin' => 'TestPlugin',
